...
function validateuser() {
    ...
    if (UserName == "shg" && Password == "Hapo@2229") {
        ...
        if (attempt == 0) {
            ...
            function myGreeting() {
                window.alert("Redirecting to Home Page Within 5 Minutes, try Some other times to login in!!");
...
//     var fieldRegister = document.getElementById("field").value;
//     var opt1 = document.getElementById("option1").value;
//     var op12 = document.getElementById("option2").value;
//     var fieldError = document.getElementById("field");
//     if (fieldRegister != opt1 || fieldRegister != opt2 || fieldRegister== "") {
//         fieldError.style.border = ".1rem solid red";
//         fieldError.style.boxShadow = ".3rem .3rem 0 #FFCCCB";
//         return false;
//     }
//     fieldError.style.border = ".1rem solid green";
//     fieldError.style.boxShadow = ".3rem .3rem 0 #90EE90";
// }
